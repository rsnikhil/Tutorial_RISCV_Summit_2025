...
Sail RISC-V simulator, one needs to install the *OCaml* system which
also installs the Sail compiler.

// ----------------------------------------------------------------
==== Installing the *OCaml* compiler and the *Sail* compiler
...
and you can confirm that you have the Sail compiler installed in the
OCaml environment like this:
