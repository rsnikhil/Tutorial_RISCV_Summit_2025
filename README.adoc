...
:revdate: 2025-10-14
:imagesdir: Doc/Figs
:keywords: Bluespec, B-Lang, BSV, BH, RISC-V, Pipelined CPU, HDL, HLHDL, High Level Hardware Design Language
...
* link:Nikhil_Tutorial_Invitation.m4v[A brief video invitation] to attend this tutorial.
...
* link:Slides_Nikhil_RISCV_Summit_Tutorial.pdf[PDF slides] for the tutorial
  (final version will be made available shortly before the
  tutorial date).

* Instructions for acquiring and installing all resources/tools
  needed
  for "hands-on" participation (all are free and open-source)
  (link:Doc/Resources.adoc[adoc version]) (link:Doc/Resources.html[html version])
+
[IMPORTANT]
====
